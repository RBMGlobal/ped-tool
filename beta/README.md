# PED tool — beta layout

RBM Global branding, and function access restructured after TAK_OS. The tool itself is
unchanged; see `BETA_NOTES.md` in the build folder. Live tool stays at `/ped-tool/`.
